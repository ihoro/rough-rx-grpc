...
class RxGrpc {
  constructor(protoFileGlobs, options) {
    ...
    this.withProtoFileGlobs(protoFileGlobs);
  ...
  withProtoFileGlobs(protoFileGlobs) {
    if (!protoFileGlobs)
      return this;
    ...
    return new Proxy({}, {
      get: (target, property, receiver) => {
        ...
        if (typeof serviceMethod !== 'function')
          throw new Error(`${property} service method not found.`);
  ...
  _wrapServiceMethod(client, serviceMethod) {
    return (request) => {
      return Observable.create(observer => {
        ...
        serviceMethod.apply(client, [ request, callback ]);
      });
    };
  }
